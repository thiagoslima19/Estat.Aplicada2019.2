...
hist(IDADEMAE,breaks=c(17,20,25,29,33,37,40),freq=T,main="Número de Gestantes por Faixa Etária", xlim=c(17,40),xlab="Idades",ylab="Frequência",col="purple")
...
t1=hist(PESO[RACACOR2=="Branca"],main="Distribuição do Peso do Bebê de Cor/Raça Branca",col="blue",ylab="Frequência",xlab="Peso do Bebê")
t2=hist(PESO[RACACOR2=="Negra"],main="Distribuição do Peso do Bebê de Cor/Raça Negra",col="orange",ylab="Frequência",xlab="Peso do Bebê")
t3=hist(PESO[RACACOR2=="Outros"],main="Distribuição do Peso do Bebê de Outras Raças",col="purple",ylab="Frequência",xlab="Peso do Bebê")
