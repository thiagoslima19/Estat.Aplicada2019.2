...
ks.test(PESO[RACACOR2=="Branca"],mean(PESO[RACACOR2=="Branca"]),sd(PESO[RACACOR2=="Branca"]))
ks.test(PESO[RACACOR2=="Negra"],mean(PESO[RACACOR2=="Negra"]),sd(PESO[RACACOR2=="Negra"]))
ks.test(PESO[RACACOR2=="Outros"],mean(PESO[RACACOR2=="Outros"]),sd(PESO[RACACOR2=="Outros"]))
